...
import ButImg from './img/yuan.png'
                ...
                <div className={`${classes.rateOfRiskPage} ${classes.position_rela}`}>
                    <Row className={ browserRedirect() === 3 ? classes.rateOfRiskPageTitle_tablet : classes.rateOfRiskPageTitle}>
                        ...
                        <Col className="text-right" lg="5" style={browserRedirect() === 3 ? {paddingRight:0} : null}>        
                            <Link 
                                to={{ pathname: `/free-story-chat-page/${vMultiScenraios[0]?.taskID}/${lessonId}`}}
                                onClick={()=>{
                                    setLocationState({ freeModel:true , senario:vMultiScenraios[0] }, `free-story-chat-page/${vMultiScenraios[0]?.taskID}/${lessonId}`)
                                }}
                            >
                                { browserRedirect() === 1 ? 
