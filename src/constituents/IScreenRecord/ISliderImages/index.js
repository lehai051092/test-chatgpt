...
import './style.css'
import pointerLeftBlue from '../../../property/images/free_story/pointer_left_blue.png'
import pointerRightBlue from '../../../property/images/free_story/pointer_right_blue.png'
import pointerLeftGray from '../../../property/images/free_story/pointer_left_gray.png'
import pointerRightGray from '../../../property/images/free_story/pointer_right_gray.png'

import unclickLeft from '../../../property/images/free_story/unclick_left.png'
import unclickRight from '../../../property/images/free_story/unclick_right_new.png'
import tabletLeft from '../../../property/images/free_story/tablet_left.png'
import tabletRight from '../../../property/images/free_story/tablet_right_new.png'
...
const SliderImages = () => {
    ...
    useEffect(() => {
        let lessonId = location.pathname.split('/')[3];
        const index = lessonId.indexOf("?");
        if(index !== -1) lessonId = lessonId.slice(0, index)
        getImageArray(location.pathname.split('/')[2], lessonId)
    }, [location.pathname])
        ...
        if(sliderCore.current){
            if (browserRedirect()==3) {
                ...
                if (window.orientation === 90 || window.orientation === -90) {
                    sliderImgDom.style.height = '51vh'
                }else{
                    sliderImgDom.style.height = '43vh'
                }
                ...
                setRect([sliderCore.current.clientWidth * 0.85, sliderCore.current.height]);
                if (document.getElementById("task_list_title_sub")) {
                    document.getElementById("task_list_title_sub").style.fontSize = "16px";
                }
        ...
        <div className={styles.slider_image} ref={sliderImg}>
            ...
            <div className={styles.slider_core}>
                <div className={styles.pdf_controller}>
                    <div className={styles.pointer} onClick={onPrevious} style={ pageNumber === 1 ? {cursor:'not-allowed'} : {} }>
                        {
                            browserRedirect() === 2 ?
                                <>
                                {
                                ...
                                {
                                    pageNumber === 1 ?
                                    <img src={pointerLeftGray} className={styles.pointer_button_l_pc} />
                                    :
                                    <img src={pointerLeftBlue} className={styles.pointer_button_l_pc} />
                                }
                                </>
                                :
                                browserRedirect() === 3 ?
                ...
                <div className={styles.pdf_controller}>
                    <div className={styles.pointer} onClick={onNext} style={ pageNumber === numPages ? {cursor:'not-allowed'} : {} }>
                        {
                            browserRedirect() === 2 ?
                                <>
                                {
                            ...
                            browserRedirect() === 1 ?
                                ...
                                {
                                     pageNumber === numPages?
                                    <img src={pointerRightGray} className={styles.pointer_button_r_pc} />
                                    :
                                    <img src={pointerRightBlue} className={styles.pointer_button_r_pc} />
                                }
                                </>
                                :
                            browserRedirect() === 3 ?
...

                {
                    numPages ?
                        <div
                            ...
                            style={document.body.offsetHeight / document.body.offsetWidth > 1 || browserRedirect() === 3? document.body.offsetHeight / document.body.offsetWidth > 1 ? { bottom: '38%' } : { left: '50%', transform: 'translate(-50%, 0%)' } : document.body.offsetHeight < 450 ? { right: 0 } : { right: "3%" }}
                        >
